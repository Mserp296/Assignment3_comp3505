...
public abstract class ChartFactory {
    ...
    public static JFreeChart createPieChart(String title,
        ...
        return new JFreeChart(
            title, org.jfree.chart.DEFAULT_TITLE_FONT, plot, legend
        );
    ...
    public static JFreeChart createScatterPlot(String title, String xAxisLabel,
        ...
        JFreeChart chart = new JFreeChart(title, org.jfree.chart.DEFAULT_TITLE_FONT,
                plot, legend);
        return chart;
    ...
    public static JFreeChart createWaferMapChart(String title,
        ...
        JFreeChart chart = new JFreeChart(
            title,
            org.jfree.chart.DEFAULT_TITLE_FONT,
            plot,
            legend
        );
